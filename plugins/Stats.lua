...
local function run(msg, matches)
  if matches[1]:lower() == 'grandex' then -- Put everything you like :)
    local about = _config.about_text
    local name = user_print_name(msg.from)
    savelog(msg.to.id, name.." ["..msg.from.id.."] used /grandex ")
    return about
  end 
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "grandex" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (grandex)",-- Put everything you like :)
		"^[!/]([Gg]randex)"-- Put everything you like :)
    }, 
  run = run
}
